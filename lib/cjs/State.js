...
exports.resolveAll = exports.getGlobal = exports.createAsyncPersistent = exports.reset = exports.useObserve = exports.clearPersistent = exports.createPersistent = exports.intercept = exports.observe = exports.useAsync = exports.use = exports.observable = exports.global = exports.createAsync = exports.create = void 0;
...
const createAsyncInternal = (resolver) => {
 ...
 */
const createAsync = (resolver, resolve = false) => {
 ...
 */
const useAsync = (state, resolveOnMount = false) => {
    const [_state, _setState] = react_1.default.useState({ state: wrapState(state) });
    react_1.default.useEffect(() => {
        const removeDispatcher = addDispatcher(_state.state, _setState);
        return removeDispatcher;
    }, [_setState]);
